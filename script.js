function showProfile() {
    ...
    const state = document.getElementById("state-code").value;
    ...
    if (birthday !== "") {
        message += "Your birthday is " + birthday + ". 🎉<br>";
    }
    if (phone !== "") {
        message += "Your phone number is " + phone + ".<br>";
    }
    if (state !== "") {
        message += "You live in this state: " + state + ".";
    }
